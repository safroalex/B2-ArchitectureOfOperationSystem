...
public class Statistics {
    ...
    public String toString() {
        System.out.println("Start of toString"); // временный вывод
        ...
        for (Map.Entry<Integer, Integer> entry : requestsGeneratedBySource.entrySet()) {
            System.out.println("In requestsGeneratedBySource loop"); // временный вывод
        ...
        for (Map.Entry<Integer, Integer> entry : requestsDeniedBySource.entrySet()) {
            System.out.println("In requestsDeniedBySource loop"); // временный вывод
            sb.append("Source ").append(entry.getKey()).append(": ").append(entry.getValue()).append("\n");
        }

        sb.append("Total service time by source:\n");
        for (Map.Entry<Integer, Double> entry : totalServiceTimeBySource.entrySet()) {
            System.out.println("In totalServiceTimeBySource loop"); // временный вывод
            sb.append("Source ").append(entry.getKey()).append(": ").append(entry.getValue()).append("\n");
        }

        // По аналогии можно добавить временные выводы и для других коллекций в вашем классе

        System.out.println("End of toString"); // временный вывод
        return sb.toString();
    }
